...
DATA = {
 ...
 "sponsors": [
   {"img":"img/PCS_Logo_with_strap_line.png", "name":"PCS Instruments"},
   {"img":"img/Rtec-High-Res-Rtec-Instruments-Logo-M-01A.png", "name":"Rtec Instruments"},
   {"img":"img/CN_Tech_-_MAIN_CN_Tech_Logo.png", "name":"CN Tech"},
   {"img":"img/Mechanical-Engineers-Logo-HR.png", "name":"Institution of Mechanical Engineers"},
   {"img":"img/RSC-brand-guidelines-2019_tcm18-246471.png", "name":"Royal Society of Chemistry"},
   {"img":"img/Jost_Foundation_only_for_brochure.png", "name":"The Jost Foundation"},
 ],
